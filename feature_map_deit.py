...
model.load_state_dict(torch.load("best_checkpoint_deit.pth", map_location='cpu'))
model.eval()
...
conv_layers = [model_children[0], model_children[1]]
...
plt.savefig(str('feature_maps_deit.jpg'), bbox_inches='tight')
